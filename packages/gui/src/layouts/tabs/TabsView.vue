...
export default {
  ...
  computed: {
    ...
    menuItemList() {
      return [
        { key: "1", icon: VerticalRightOutlined, text: this.$t("closeLeft") },
        { key: "2", icon: VerticalLeftOutlined, text: this.$t("closeRight") },
        { key: "3", icon: CloseOutlined, text: this.$t("closeOthers") },
        { key: "4", icon: SyncOutlined, text: this.$t("refresh") },
      ];
    },
  ...
  methods: {
    ...
    createPage(route) {
      return {
        ...
        newFullpath: route.meta.fullPath,
    ...
    setCachedKey(route) {
      ...
      if (!page._init_) {
        const vnode =
          this.$refs.tabContent && this.$refs.tabContent.$
            ? this.$refs.tabContent.$.vnode
            : null;
        if (vnode) {
          page.cachedKey = vnode.key + vnode.component.uid;
        }
        page._init_ = true;
      }
    },
