<template>
  <PageLayout :title="$t('Daemon Sets')">
          ...
          >
            ...
            >
              <ServiceList
                :namespace="namespace"
                :has-search="false"
                :url="$REST.KUBE.DAEMONSET + '/' + pid + '/service'"
              />
            </a-card>
          </a-tab-pane>
          <a-tab-pane
          ...
          >
            ...
            >
              <PodList
                :namespace="namespace"
                :has-search="false"
                :url="$REST.KUBE.DAEMONSET + '/' + pid + '/pod'"
              />
            </a-card>
          </a-tab-pane>
          <a-tab-pane
          ...
          >
            ...
            >
              <EventList
                :namespace="namespace"
                :has-search="false"
                :url="$REST.KUBE.DAEMONSET + '/' + pid + '/event'"
              />
            </a-card>
          </a-tab-pane>
        </a-tabs>
