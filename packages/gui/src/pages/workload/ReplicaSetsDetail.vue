<template>
  <PageLayout :title="$t('Replica Sets')">
          ...
          >
            ...
            >
              <ServiceList
                :namespace="namespace"
                :has-search="false"
                :url="$REST.KUBE.REPLICASET + '/' + pid + '/service'"
              />
            </a-card>
          </a-tab-pane>
          <a-tab-pane
          ...
          >
            ...
            >
              <PodList
                :namespace="namespace"
                :has-search="false"
                :url="$REST.KUBE.REPLICASET + '/' + pid + '/pod'"
              />
            </a-card>
          </a-tab-pane>
          <a-tab-pane
          ...
          >
            ...
            >
              <EventList
                :namespace="namespace"
                :has-search="false"
                :url="$REST.KUBE.REPLICASET + '/' + pid + '/event'"
              />
            </a-card>
          </a-tab-pane>
        </a-tabs>
